...
const SignIn = () => {
    const {signInUserWithPassword,setUser} = useContext(AuthContext);
    ...
    return (
        <div>
            ...
            <div>
                <div className="flex items-center justify-center min-h-screen p-4 gap-11 bg-gradient-to-r from-blue-500 to-purple-600">
